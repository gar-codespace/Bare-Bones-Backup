"""
The three subroutines, Backup, Compare amd Synchronize.
Any new subroutines can be added here.
Compare and Synchronize are essentially the same, Sync takes action.
"""

import Entities
from components.Session import Model_Entities

SUBROUTINE_NAME = "Subroutines"
...
class Model:
    """
    Backup from source to target.
    Work in one direction only, source to target.
    Take action per settings.
    """
